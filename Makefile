...
test-e2e: ## docker
	...
	# NOTE(bwplotka):
	# * No failfast to not confuse the errors. For local debugging of e2e it's useful to add -failfast or limit to single test.
	...
	@go test -parallel 1 -failfast -timeout 10m -v ./test/e2e/...
